...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{ URL ('/lembaga/dpm/dashboard')}}" class="logo">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                 DPM
                  <small>Dewan Perwakilan Mahasiswa</small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ URL ('/lembaga/dpm/profil')}} " class="btn btn-default btn-flat">Profile</a>
                </div>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ URL ('/lembaga/dpm/dashboard')}}"><i class="fa fa-book"></i> <span>Dashboard</span></a></li>
          ...
          <ul class="treeview-menu">
            <li class="treeview menu-open" style="display: block;">
              <ul class="treeview-menu" style="display: block;">
                  <li><a href="{{ URL ('/lembaga/dpm/didalamkampus') }}"> Di dalam kampus</a></li>
                  <li><a href="{{ URL ('/lembaga/dpm/diluarkampus') }}"> Di luar kampus</a></li>
                </ul>
              </li>
            </ul>
              ...
              <ul class="treeview-menu">
                    <li class="treeview menu-open" style="display: block;">
                        ...
                        <li class="treeview-menu" style="display: block;">
                            <li><a href="{{ URL ('/lembaga/dpm/prestasi') }}"> Di dalam kampus</a></li>
                            <li><a href="{{ URL ('/lembaga/dpm/prestasi') }}"> Di luar kampus</a></li>
                        </li>
                      </ul>
                      <li class="treeview menu-open" style="display: block;">
                        <a href="#">Produk
                  ...
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      <li><a href="{{ URL ('/lembaga/dpm/dokumentasiinternal') }}"><i class="fa fa-circle-o"></i> Dokumentasi Internal</a></li>
                      <li><a href="{{ URL ('/lembaga/dpm/dokumentasieksternal') }}"><i class="fa fa-circle-o"></i> Dokumentasi Eksternal</a></li>
                      </li>
                    </ul>
                  <li><a href="{{ URL ('/lembaga/dpm/laporan') }}"><i class="fa fa-book"></i> <span>Laporan</span></a></li>
                </ul>
              </section>
    <!-- /.sidebar -->
  </aside>
