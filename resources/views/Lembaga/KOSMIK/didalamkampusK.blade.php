                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/KOSMIK/didalamkampus" method="POST">
                                            {{csrf_field()}}
                                          ...
                                          @foreach ($data as $d)
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="{{$table->nama_kegiatan}}" class="form-control" id="recipient-name" placeholder="Event Name" required>
                                                {{-- <option @if($event->category =="Competition") selected @endif value="competition">Competition</option> --}}
                                            </div>
                                            <div class="form-group">
                                              <label>Program kerja divisi</label>
                                              <select class="form-control select2 select2-hidden-accessible" name="category" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                <option @if($table->program_kerja_divisi =="di_dalam_kampus") selected @endif value="Di dalam kampus">Didalam kampus</option>
                                                <option @if($table->program_kerja_divisi =="di_luar_kampus") selected @endif value="Di luar kampus">Diluar kampus</option>
                                              </select>              
                                            </label>
                                          </div>
                                          <div class="form-group">
                                                <label for="recipient-name" class="col-form-label">Predikat</label>
                                                <input type="text" name="kejuaraan" value="{{$table->predikat}}" class="form-control" id="recipient-name" placeholder="Juara satu" required>
                                            ...
                                            <div class="form-group">
                                              ...
                                              <input type="text" name="kejuaraan" value="{{$table->predikat}}" class="form-control" id="recipient-name" placeholder="Juara satu">
                                          </div>
                                          <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">tempat</label>
                                            <input type="text" name="kejuaraan" value="{{$table->tempat}}" class="form-control" id="recipient-name" placeholder="Juara satu">
                                            </div>
                                            <div class="form-group">
                                                <label for="recipient-name" class="col-form-label">tingkat</label>
                                                <input type="text" name="kejuaraan" value="{{$table->tingkat}}" class="form-control" id="recipient-name" placeholder="Juara satu">
                                            </div>
                                            <div class="form-group">
                                                <label for="recipient-name" class="col-form-label">Scan_bukti</label>
                                                <input type="text" name="kejuaraan" value="{{$table->scan_bukti}}" class="form-control" id="recipient-name" placeholder="Juara satu">
                                            </div>
                                            {{-- <div class="form-group">
