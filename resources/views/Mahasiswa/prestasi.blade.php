              ...
              <div class="modal-dialog" role="document">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action={{ url('/Mahasiswa/prestasi')}} method="post">
                              {{csrf_field()}}
                              @if(count($errors) > 0)
                            ...
                            <label>Juara</label>
                              <select class="form-control select2 select2-hidden-accessible" name="juara" style="width: 100%;" tabindex="-1" aria-hidden="true">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" name="nama_lomba" class="form-control" id="recipient-name" placeholder="Event Name">
                              </div>
                            <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="angkatan" class="form-control" id="recipient-name" placeholder="Event Name">
                          </div>
                          {{-- <label>Bidang</label>
