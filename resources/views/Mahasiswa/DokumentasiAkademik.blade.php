...
@section('content')
    <section class="content-header">
        <h1>Halaman
        <small>Dokumentasi Non Akademis</small>
        </h1>
    </section>
                    ...
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="box">
                          ...
                          <div class="box-body">
                            <button type="button" class="btn btn-default btn-block" data-toggle="modal" data-target="#tambahdokumentasi" data-whatever="@mdo">
