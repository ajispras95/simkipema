                      ...
                      <div class="modal-dialog" role="document">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action={{ url('/Mahasiswa/dokumentasiinternal')}} method="post">
                                      {{csrf_field()}}
                                      @if(count($errors) > 0)
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="tanggal_kejuaraan" class="form-control" id="recipient-name" placeholder="26 Maret 2018">
                                  </div>
